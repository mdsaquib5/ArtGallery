                ...
                <form onSubmit={onSubmitHandler} className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                    ...
                    <div className='lg:col-span-1'>
                        <div className='sticky top-24 space-y-6'>
                            ...
                            <button 
                                type='submit'
                                className='w-full py-4 cursor-pointer bg-black hover:bg-[#1a1a1a] text-white font-light text-sm tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-3'
                            >
